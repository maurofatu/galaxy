            ...
            <div class=" col ">
                <div class="card">
                    <div class="card-header bg-transparent">
                        <h3 class="mb-0 text-center"><b>AGREGAR JUGADORES</b></h3>
                    </div>
                    <div class="card-body">
                        <div class="row icon-examples">

                            <form action="{{ route('jugadores.store') }}" method="POST" name="formulario" id="formulario">
                              @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="nombre">Cédula del Lider</label>
                                            <input class="form-control" type="number" name="cedulalider" id="cedulalider"
                                                onchange="buscarcapitan(event)" value="{{ old('cedulalider', '') }}"
                                                required />
                                            @error('cedulalider')
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label for="nombre">Nombres y Apellidos del Lider</label>
                                            <input class="form-control" type="text" name="nombrelider" id="nombrelider"
                                                value="{{ old('nombrelider', '') }}" readonly />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="depvot" id="depvot"
                                                value="{{ old('depvot', '') }}" required />
                                            @error('depvot')
                                                <small style="color: #FF0000"> {{ $message }} </small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="munvot" id="munvot"
                                                value="{{ old('munvot', '') }}" required />
                                            @error('munvot')
                                                <small style="color: #FF0000"> {{ $message }} </small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="lugvot" id="lugvot"
                                                value="{{ old('lugvot', '') }}" required />
                                            @error('lugvot')
                                                <small style="color: #FF0000"> {{ $message }} </small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="mesvot" id="mesvot"
                                                value="{{ old('mesvot', '') }}" required />
                                            @error('mesvot')
                                                <small style="color: #FF0000"> {{ $message }} </small>
                                            @enderror
                                        </div>
